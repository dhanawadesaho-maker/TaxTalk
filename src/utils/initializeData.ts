// Utility to clear and reinitialize localStorage data
export function clearAndInitializeData() {
  // Clear existing data
  ...
  console.log('Data reinitialized with users:', mockUsers.map(u => ({ email: u.email, password: u.password })));
}